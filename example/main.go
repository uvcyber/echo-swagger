...
import (
	...
	echoSwagger "github.com/uvcyber/echo-swagger"
	_ "github.com/uvcyber/echo-swagger/example/docs" // docs is generated by Swag CLI, you have to import it.
)
...
// @servers.url petstore.swagger.io/v2
func main() {
	e := echo.New()
